...
public final class Transformation {
   ...
   public static final Codec<Transformation> CODEC = RecordCodecBuilder.create((recordcodecbuilder_instance) -> recordcodecbuilder_instance.group(ExtraCodecs.VECTOR3F.fieldOf("translation").forGetter((transformation3) -> transformation3.translation), ExtraCodecs.QUATERNIONF.fieldOf("left_rotation").forGetter((transformation2) -> transformation2.leftRotation), ExtraCodecs.VECTOR3F.fieldOf("scale").forGetter((transformation1) -> transformation1.scale), ExtraCodecs.QUATERNIONF.fieldOf("right_rotation").forGetter((transformation) -> transformation.rightRotation)).apply(recordcodecbuilder_instance, Transformation::new));
   public static final Codec<Transformation> EXTENDED_CODEC = Codec.either(CODEC, ExtraCodecs.MATRIX4F.xmap(Transformation::new, Transformation::getMatrix)).xmap((either) -> either.map((transformation1) -> transformation1, (transformation) -> transformation), Either::left);
   ...
   public Transformation(@Nullable Vector3f vector3f, @Nullable Quaternionf quaternionf, @Nullable Vector3f vector3f1, @Nullable Quaternionf quaternionf1) {
      this.matrix = compose(vector3f, quaternionf, vector3f1, quaternionf1);
      this.translation = vector3f != null ? vector3f : new Vector3f();
      this.leftRotation = quaternionf != null ? quaternionf : new Quaternionf();
      this.scale = vector3f1 != null ? vector3f1 : new Vector3f(1.0F, 1.0F, 1.0F);
      this.rightRotation = quaternionf1 != null ? quaternionf1 : new Quaternionf();
   ...
   private static Matrix4f compose(@Nullable Vector3f vector3f, @Nullable Quaternionf quaternionf, @Nullable Vector3f vector3f1, @Nullable Quaternionf quaternionf1) {
      ...
      if (vector3f1 != null) {
         matrix4f.scale(vector3f1);
      }

      if (quaternionf1 != null) {
         matrix4f.rotate(quaternionf1);
      }
   ...
   public Transformation slerp(Transformation transformation, float f) {
      ...
      vector3f1.lerp(transformation.getScale(), f);
      quaternionf1.slerp(transformation.getRightRotation(), f);
