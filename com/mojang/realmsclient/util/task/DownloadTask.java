...
public class DownloadTask extends LongRunningTask {
   ...
   public DownloadTask(long i, int j, String s, Screen screen) {
      this.worldId = i;
      this.slot = j;
   ...
   public void run() {
      ...
      while(i < 25) {
         try {
            ...
            setScreen(new RealmsDownloadLatestWorldScreen(this.lastScreen, worlddownload, this.downloadName, (flag) -> {
            }));
            return;
