...
public final class Selector {
   ...
   private static final Comparator<Property.Value<?>> COMPARE_BY_NAME = Comparator.comparing((property_value) -> property_value.property().getName());
   ...
   public static Selector of(Property.Value<?>... aproperty_value) {
      return new Selector(ImmutableList.copyOf(aproperty_value));
   }
