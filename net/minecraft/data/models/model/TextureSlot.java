...
public final class TextureSlot {
   ...
   private static TextureSlot create(String s) {
      return new TextureSlot(s, (TextureSlot)null);
   }

   private static TextureSlot create(String s, TextureSlot textureslot) {
      return new TextureSlot(s, textureslot);
   }

   private TextureSlot(String s, @Nullable TextureSlot textureslot) {
      this.id = s;
