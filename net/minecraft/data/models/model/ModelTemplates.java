...
public class ModelTemplates {
   ...
   public static final ModelTemplate[] STEMS = IntStream.range(0, 8).mapToObj((i) -> create("stem_growth" + i, "_stage" + i, TextureSlot.STEM)).toArray((i) -> new ModelTemplate[i]);
   ...
   private static ModelTemplate create(TextureSlot... atextureslot) {
      return new ModelTemplate(Optional.empty(), Optional.empty(), atextureslot);
   }

   private static ModelTemplate create(String s, TextureSlot... atextureslot) {
      return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + s)), Optional.empty(), atextureslot);
   }

   private static ModelTemplate createItem(String s, TextureSlot... atextureslot) {
      return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "item/" + s)), Optional.empty(), atextureslot);
   }

   private static ModelTemplate create(String s, String s1, TextureSlot... atextureslot) {
      return new ModelTemplate(Optional.of(new ResourceLocation("minecraft", "block/" + s)), Optional.of(s1), atextureslot);
   }
}
