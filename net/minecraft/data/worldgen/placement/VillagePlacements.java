...
public class VillagePlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> bootstapcontext) {
      ...
      PlacementUtils.register(bootstapcontext, PILE_MELON_VILLAGE, holder1);
      PlacementUtils.register(bootstapcontext, PILE_SNOW_VILLAGE, holder2);
      PlacementUtils.register(bootstapcontext, PILE_ICE_VILLAGE, holder3);
      PlacementUtils.register(bootstapcontext, PILE_PUMPKIN_VILLAGE, holder4);
      PlacementUtils.register(bootstapcontext, OAK_VILLAGE, holder5, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(bootstapcontext, ACACIA_VILLAGE, holder6, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
      PlacementUtils.register(bootstapcontext, SPRUCE_VILLAGE, holder7, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(bootstapcontext, PINE_VILLAGE, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(bootstapcontext, PATCH_CACTUS_VILLAGE, holder9);
      PlacementUtils.register(bootstapcontext, FLOWER_PLAIN_VILLAGE, holder10);
      PlacementUtils.register(bootstapcontext, PATCH_TAIGA_GRASS_VILLAGE, holder11);
      PlacementUtils.register(bootstapcontext, PATCH_BERRY_BUSH_VILLAGE, holder12);
   }
}
