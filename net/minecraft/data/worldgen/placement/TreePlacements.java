...
public class TreePlacements {
   ...
   public static void bootstrap(BootstapContext<PlacedFeature> bootstapcontext) {
      ...
      PlacementUtils.register(bootstapcontext, WARPED_FUNGI, holder1, CountOnEveryLayerPlacement.of(8), BiomeFilter.biome());
      PlacementUtils.register(bootstapcontext, OAK_CHECKED, holder2, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
      PlacementUtils.register(bootstapcontext, DARK_OAK_CHECKED, holder3, PlacementUtils.filteredByBlockSurvival(Blocks.DARK_OAK_SAPLING));
      PlacementUtils.register(bootstapcontext, BIRCH_CHECKED, holder4, PlacementUtils.filteredByBlockSurvival(Blocks.BIRCH_SAPLING));
      PlacementUtils.register(bootstapcontext, ACACIA_CHECKED, holder5, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
      PlacementUtils.register(bootstapcontext, SPRUCE_CHECKED, holder6, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
      PlacementUtils.register(bootstapcontext, MANGROVE_CHECKED, holder7, PlacementUtils.filteredByBlockSurvival(Blocks.MANGROVE_PROPAGULE));
      PlacementUtils.register(bootstapcontext, CHERRY_CHECKED, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING));
      ...
      PlacementUtils.register(bootstapcontext, SPRUCE_ON_SNOW, holder6, list);
      ...
      PlacementUtils.register(bootstapcontext, CHERRY_BEES_005, holder26, PlacementUtils.filteredByBlockSurvival(Blocks.CHERRY_SAPLING));
   }
}
