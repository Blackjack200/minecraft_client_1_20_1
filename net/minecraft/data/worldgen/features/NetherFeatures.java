...
public class NetherFeatures {
   ...
   public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapcontext) {
      ...
      FeatureUtils.register(bootstapcontext, WARPED_FOREST_VEGETION, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedstateprovider1, 8, 4));
      FeatureUtils.register(bootstapcontext, WARPED_FOREST_VEGETATION_BONEMEAL, Feature.NETHER_FOREST_VEGETATION, new NetherForestVegetationConfig(weightedstateprovider1, 3, 1));
