...
public class OreFeatures {
   ...
   public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> bootstapcontext) {
      ...
      FeatureUtils.register(bootstapcontext, ORE_MAGMA, Feature.ORE, new OreConfiguration(ruletest3, Blocks.MAGMA_BLOCK.defaultBlockState(), 33));
      FeatureUtils.register(bootstapcontext, ORE_SOUL_SAND, Feature.ORE, new OreConfiguration(ruletest3, Blocks.SOUL_SAND.defaultBlockState(), 12));
      FeatureUtils.register(bootstapcontext, ORE_NETHER_GOLD, Feature.ORE, new OreConfiguration(ruletest3, Blocks.NETHER_GOLD_ORE.defaultBlockState(), 10));
      FeatureUtils.register(bootstapcontext, ORE_QUARTZ, Feature.ORE, new OreConfiguration(ruletest3, Blocks.NETHER_QUARTZ_ORE.defaultBlockState(), 14));
      FeatureUtils.register(bootstapcontext, ORE_GRAVEL_NETHER, Feature.ORE, new OreConfiguration(ruletest3, Blocks.GRAVEL.defaultBlockState(), 33));
      FeatureUtils.register(bootstapcontext, ORE_BLACKSTONE, Feature.ORE, new OreConfiguration(ruletest3, Blocks.BLACKSTONE.defaultBlockState(), 33));
      ...
      FeatureUtils.register(bootstapcontext, ORE_COAL, Feature.ORE, new OreConfiguration(list5, 17));
      FeatureUtils.register(bootstapcontext, ORE_COAL_BURIED, Feature.ORE, new OreConfiguration(list5, 17, 0.5F));
      ...
      FeatureUtils.register(bootstapcontext, ORE_GOLD, Feature.ORE, new OreConfiguration(list1, 9));
      FeatureUtils.register(bootstapcontext, ORE_GOLD_BURIED, Feature.ORE, new OreConfiguration(list1, 9, 0.5F));
      FeatureUtils.register(bootstapcontext, ORE_REDSTONE, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(ruletest1, Blocks.REDSTONE_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_REDSTONE_ORE.defaultBlockState())), 8));
      FeatureUtils.register(bootstapcontext, ORE_DIAMOND_SMALL, Feature.ORE, new OreConfiguration(list2, 4, 0.5F));
      FeatureUtils.register(bootstapcontext, ORE_DIAMOND_LARGE, Feature.ORE, new OreConfiguration(list2, 12, 0.7F));
      FeatureUtils.register(bootstapcontext, ORE_DIAMOND_BURIED, Feature.ORE, new OreConfiguration(list2, 8, 1.0F));
      FeatureUtils.register(bootstapcontext, ORE_LAPIS, Feature.ORE, new OreConfiguration(list3, 7));
      FeatureUtils.register(bootstapcontext, ORE_LAPIS_BURIED, Feature.ORE, new OreConfiguration(list3, 7, 1.0F));
      FeatureUtils.register(bootstapcontext, ORE_INFESTED, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(ruletest1, Blocks.INFESTED_STONE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.INFESTED_DEEPSLATE.defaultBlockState())), 9));
      FeatureUtils.register(bootstapcontext, ORE_EMERALD, Feature.ORE, new OreConfiguration(List.of(OreConfiguration.target(ruletest1, Blocks.EMERALD_ORE.defaultBlockState()), OreConfiguration.target(ruletest2, Blocks.DEEPSLATE_EMERALD_ORE.defaultBlockState())), 3));
      FeatureUtils.register(bootstapcontext, ORE_ANCIENT_DEBRIS_LARGE, Feature.SCATTERED_ORE, new OreConfiguration(ruletest4, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 3, 1.0F));
      FeatureUtils.register(bootstapcontext, ORE_ANCIENT_DEBRIS_SMALL, Feature.SCATTERED_ORE, new OreConfiguration(ruletest4, Blocks.ANCIENT_DEBRIS.defaultBlockState(), 2, 1.0F));
      FeatureUtils.register(bootstapcontext, ORE_COPPPER_SMALL, Feature.ORE, new OreConfiguration(list4, 10));
      FeatureUtils.register(bootstapcontext, ORE_COPPER_LARGE, Feature.ORE, new OreConfiguration(list4, 20));
