...
public abstract class BiomeData {
   public static void bootstrap(BootstapContext<Biome> bootstapcontext) {
      ...
      bootstapcontext.register(Biomes.MEADOW, OverworldBiomes.meadowOrCherryGrove(holdergetter, holdergetter1, false));
      bootstapcontext.register(Biomes.CHERRY_GROVE, OverworldBiomes.meadowOrCherryGrove(holdergetter, holdergetter1, true));
