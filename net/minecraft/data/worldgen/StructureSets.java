...
public interface StructureSets {
   static void bootstrap(BootstapContext<StructureSet> bootstapcontext) {
      ...
      HolderGetter<Biome> holdergetter1 = bootstapcontext.lookup(Registries.BIOME);
      Holder.Reference<StructureSet> holder_reference = bootstapcontext.register(BuiltinStructureSets.VILLAGES, new StructureSet(List.of(StructureSet.entry(holdergetter.getOrThrow(BuiltinStructures.VILLAGE_PLAINS)), StructureSet.entry(holdergetter.getOrThrow(BuiltinStructures.VILLAGE_DESERT)), StructureSet.entry(holdergetter.getOrThrow(BuiltinStructures.VILLAGE_SAVANNA)), StructureSet.entry(holdergetter.getOrThrow(BuiltinStructures.VILLAGE_SNOWY)), StructureSet.entry(holdergetter.getOrThrow(BuiltinStructures.VILLAGE_TAIGA))), new RandomSpreadStructurePlacement(34, 8, RandomSpreadType.LINEAR, 10387312)));
      ...
      bootstapcontext.register(BuiltinStructureSets.PILLAGER_OUTPOSTS, new StructureSet(holdergetter.getOrThrow(BuiltinStructures.PILLAGER_OUTPOST), new RandomSpreadStructurePlacement(Vec3i.ZERO, StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_1, 0.2F, 165745296, Optional.of(new StructurePlacement.ExclusionZone(holder_reference, 10)), 32, 8, RandomSpreadType.LINEAR)));
      ...
      bootstapcontext.register(BuiltinStructureSets.BURIED_TREASURES, new StructureSet(holdergetter.getOrThrow(BuiltinStructures.BURIED_TREASURE), new RandomSpreadStructurePlacement(new Vec3i(9, 0, 9), StructurePlacement.FrequencyReductionMethod.LEGACY_TYPE_2, 0.01F, 0, Optional.empty(), 1, 0, RandomSpreadType.LINEAR)));
      ...
      bootstapcontext.register(BuiltinStructureSets.TRAIL_RUINS, new StructureSet(holdergetter.getOrThrow(BuiltinStructures.TRAIL_RUINS), new RandomSpreadStructurePlacement(34, 8, RandomSpreadType.LINEAR, 83469867)));
   }
}
