...
public class BiomeTagsProvider extends TagsProvider<Biome> {
   ...
   protected void addTags(HolderLookup.Provider holderlookup_provider) {
      ...
      MultiNoiseBiomeSourceParameterList.Preset.NETHER.usedBiomes().forEach(tagsprovider_tagappender::add);
      TagsProvider.TagAppender<Biome> tagsprovider_tagappender1 = this.tag(BiomeTags.IS_OVERWORLD);
      MultiNoiseBiomeSourceParameterList.Preset.OVERWORLD.usedBiomes().forEach(tagsprovider_tagappender1::add);
