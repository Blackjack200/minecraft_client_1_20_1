   ...
   public void run() {
      while(this.server.isRunning()) {
         ...
         if (k > this.maxTickTime) {
            ...
            crashreportcategory1.setDetail("Level stats", () -> Streams.stream(this.server.getAllLevels()).map((serverlevel) -> serverlevel.dimension() + ": " + serverlevel.getWatchdogStats()).collect(Collectors.joining(",\n")));
