...
public class MinecraftServerGui extends JComponent {
   ...
   private JComponent buildChatPanel() {
      ...
      jtextfield.addActionListener((actionevent) -> {
         String s1 = jtextfield.getText().trim();
         if (!s1.isEmpty()) {
            this.server.handleConsoleInput(s1, this.server.createCommandSourceStack());
         }
   ...
   public void print(JTextArea jtextarea, JScrollPane jscrollpane, String s) {
      if (!SwingUtilities.isEventDispatchThread()) {
         SwingUtilities.invokeLater(() -> this.print(jtextarea, jscrollpane, s));
      } else {
