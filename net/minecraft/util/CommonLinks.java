...
public class CommonLinks {
   ...
   public static String extendRealms(String s, String s1, boolean flag) {
      return extendRealms(s, s1) + "&ref=" + (flag ? "expiredTrial" : "expiredRealm");
   }

   public static String extendRealms(String s, String s1) {
      return "https://aka.ms/ExtendJavaRealms?subscriptionId=" + s + "&profileId=" + s1;
   }
}
