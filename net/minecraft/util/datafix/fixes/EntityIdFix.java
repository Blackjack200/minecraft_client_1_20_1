...
public class EntityIdFix extends DataFix {
   ...
   public EntityIdFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(this.convertUnchecked("item stack entity name hook converter", type, type1), this.fixTypeEverywhere("EntityIdFix", taggedchoice_taggedchoicetype, taggedchoice_taggedchoicetype1, (dynamicops) -> (pair) -> pair.mapFirst((s) -> ID_MAP.getOrDefault(s, s))));
   }
}
