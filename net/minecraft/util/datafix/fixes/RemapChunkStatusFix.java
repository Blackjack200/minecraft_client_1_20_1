...
public class RemapChunkStatusFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      return this.fixTypeEverywhereTyped(this.name, this.getInputSchema().getType(References.CHUNK), (typed) -> typed.update(DSL.remainderFinder(), (dynamic) -> dynamic.update("Status", this::fixStatus).update("below_zero_retrogen", (dynamic1) -> dynamic1.update("target_status", this::fixStatus))));
   }
