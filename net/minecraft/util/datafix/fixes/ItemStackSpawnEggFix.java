...
public class ItemStackSpawnEggFix extends DataFix {
   ...
   public ItemStackSpawnEggFix(Schema schema, boolean flag, String s) {
      super(schema, flag);
      this.itemType = s;
   }
      ...
      return this.fixTypeEverywhereTyped("ItemInstanceSpawnEggFix" + this.getOutputSchema().getVersionKey(), type, (typed) -> {
         ...
         if (optional.isPresent() && Objects.equals(optional.get().getSecond(), this.itemType)) {
            ...
            if (optional1.isPresent()) {
               return typed.set(opticfinder, Pair.of(References.ITEM_NAME.typeName(), MAP.getOrDefault(optional1.get(), "minecraft:pig_spawn_egg")));
            }
         }
