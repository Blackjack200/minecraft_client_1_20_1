...
public class ItemSpawnEggFix extends DataFix {
   private static final String[] ID_TO_ENTITY = DataFixUtils.make(new String[256], (astring) -> {
      astring[1] = "Item";
      astring[2] = "XPOrb";
      astring[7] = "ThrownEgg";
      astring[8] = "LeashKnot";
   ...
   public ItemSpawnEggFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemSpawnEggFix", type, (typed) -> {
         ...
         if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:spawn_egg")) {
            ...
            Optional<? extends Typed<?>> optional2 = optional1.flatMap((typed8) -> typed8.getOptionalTyped(opticfinder3));
            Optional<? extends Typed<?>> optional3 = optional2.flatMap((typed7) -> typed7.getOptionalTyped(opticfinder4));
            Optional<String> optional4 = optional3.flatMap((typed6) -> typed6.getOptional(opticfinder1));
            Typed<?> typed1 = typed;
            String s = ID_TO_ENTITY[short0 & 255];
            if (s != null && (!optional4.isPresent() || !Objects.equals(optional4.get(), s))) {
               ...
               Typed<?> typed5 = typed4.write().flatMap((dynamic3) -> type1.readTyped(dynamic3.set("id", dynamic1.createString(s)))).result().orElseThrow(() -> new IllegalStateException("Could not parse new entity")).getFirst();
