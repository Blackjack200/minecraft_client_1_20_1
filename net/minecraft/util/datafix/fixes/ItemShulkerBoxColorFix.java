...
public class ItemShulkerBoxColorFix extends DataFix {
   ...
   public ItemShulkerBoxColorFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
         ...
         if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:shulker_box")) {
            ...
            if (optional1.isPresent()) {
               ...
               if (optional2.isPresent()) {
                  ...
                  return typed.set(opticfinder1, typed1.set(opticfinder2, typed2.set(DSL.remainderFinder(), dynamic))).set(opticfinder, Pair.of(References.ITEM_NAME.typeName(), NAMES_BY_COLOR[i % 16]));
               }
            }
         }
