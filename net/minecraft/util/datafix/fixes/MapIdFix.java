...
public class MapIdFix extends DataFix {
   public MapIdFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Map id fix", type, (typed) -> {
         ...
         return optional.isPresent() ? typed : typed.update(DSL.remainderFinder(), (dynamic) -> dynamic.createMap(ImmutableMap.of(dynamic.createString("data"), dynamic)));
      });
   }
}
