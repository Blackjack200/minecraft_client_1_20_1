...
public class ItemPotionFix extends DataFix {
   ...
   private static final String[] POTIONS = DataFixUtils.make(new String[128], (astring) -> {
   ...
   public ItemPotionFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
         ...
         if (optional.isPresent() && Objects.equals(optional.get().getSecond(), "minecraft:potion")) {
            ...
            if (optional1.isPresent()) {
               ...
               if (!optional2.isPresent()) {
                  String s = POTIONS[short0 & 127];
                  Typed<?> typed2 = optional1.get().set(DSL.remainderFinder(), dynamic1.set("Potion", dynamic1.createString(s == null ? "minecraft:water" : s)));
