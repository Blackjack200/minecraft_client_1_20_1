...
public class ItemIdFix extends DataFix {
   ...
   public ItemIdFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("ItemIdFix", this.getInputSchema().getType(References.ITEM_STACK), this.getOutputSchema().getType(References.ITEM_STACK), (typed) -> typed.update(opticfinder, type1, (either) -> either.map((integer) -> Pair.of(References.ITEM_NAME.typeName(), getItem(integer)), (pair) -> pair)));
   }
}
