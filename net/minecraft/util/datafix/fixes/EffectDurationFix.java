...
public class EffectDurationFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return TypeRewriteRule.seq(this.fixTypeEverywhereTyped("EffectDurationEntity", schema.getType(References.ENTITY), (typed3) -> typed3.update(DSL.remainderFinder(), this::updateEntity)), this.fixTypeEverywhereTyped("EffectDurationPlayer", schema.getType(References.PLAYER), (typed2) -> typed2.update(DSL.remainderFinder(), this::updateEntity)), this.fixTypeEverywhereTyped("EffectDurationItem", type, (typed) -> {
         ...
         if (optional.filter(ITEM_TYPES::contains).isPresent()) {
            ...
            if (optional1.isPresent()) {
               ...
               Typed<?> typed1 = optional1.get().set(DSL.remainderFinder(), dynamic.update("CustomPotionEffects", this::fix));
