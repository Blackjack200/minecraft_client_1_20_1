...
public class BlockNameFlatteningFix extends DataFix {
   public BlockNameFlatteningFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
   ...
   public TypeRewriteRule makeRule() {
      ...
      if (Objects.equals(type, type2) && Objects.equals(type1, type3)) {
         return this.fixTypeEverywhere("BlockNameFlatteningFix", type2, type3, (dynamicops) -> (pair) -> pair.mapSecond((either) -> either.map(BlockStateData::upgradeBlock, (s) -> BlockStateData.upgradeBlock(NamespacedSchema.ensureNamespaced(s)))));
      } else {
