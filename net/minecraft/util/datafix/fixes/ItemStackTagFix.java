...
public abstract class ItemStackTagFix extends DataFix {
   ...
   public final TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped(this.name, type, (typed) -> {
         ...
         return optional.isPresent() && this.idFilter.test(optional.get().getSecond()) ? typed.updateTyped(opticfinder1, (typed1) -> typed1.update(DSL.remainderFinder(), this::fixItemStackTag)) : typed;
      });
   }
