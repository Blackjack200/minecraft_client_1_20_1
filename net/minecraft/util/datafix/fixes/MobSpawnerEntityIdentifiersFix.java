...
public class MobSpawnerEntityIdentifiersFix extends DataFix {
   public MobSpawnerEntityIdentifiersFix(Schema schema, boolean flag) {
      super(schema, flag);
   }
         ...
         if (optional1.isPresent()) {
            dynamic = dynamic.set("SpawnPotentials", dynamic.createList(optional1.get().map((dynamic2) -> {
               ...
               if (optional2.isPresent()) {
                  Dynamic<?> dynamic3 = DataFixUtils.orElse(dynamic2.get("Properties").result(), dynamic2.emptyMap()).set("id", dynamic2.createString(optional2.get()));
