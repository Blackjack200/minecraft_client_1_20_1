...
public class SpawnerDataFix extends DataFix {
   ...
   protected TypeRewriteRule makeRule() {
      ...
      return this.fixTypeEverywhereTyped("Fix mob spawner data structure", type, type1, (typed) -> typed.updateTyped(opticfinder, type2, (typed2) -> this.wrapEntityToSpawnData(type2, typed2)).updateTyped(opticfinder1, type3, (typed1) -> this.wrapSpawnPotentialsToWeightedEntries(type3, typed1)));
   }
