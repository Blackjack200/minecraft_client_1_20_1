...
public class V704 extends Schema {
   ...
   public Type<?> getChoiceType(DSL.TypeReference dsl_typereference, String s) {
      return Objects.equals(dsl_typereference.typeName(), References.BLOCK_ENTITY.typeName()) ? super.getChoiceType(dsl_typereference, NamespacedSchema.ensureNamespaced(s)) : super.getChoiceType(dsl_typereference, s);
   }
   ...
   public Map<String, Supplier<TypeTemplate>> registerBlockEntities(Schema schema) {
      ...
      schema.register(map, "minecraft:flower_pot", (s) -> DSL.optionalFields("Item", DSL.or(DSL.constType(DSL.intType()), References.ITEM_NAME.in(schema))));
   ...
   public void registerTypes(Schema schema, Map<String, Supplier<TypeTemplate>> map, Map<String, Supplier<TypeTemplate>> map1) {
      ...
      schema.registerType(false, References.BLOCK_ENTITY, () -> DSL.taggedChoiceLazy("id", NamespacedSchema.namespacedString(), map1));
