...
public class SimpleBitStorage implements BitStorage {
   ...
   public SimpleBitStorage(int i, int j, @Nullable long[] along) {
      ...
      if (along != null) {
         if (along.length != l) {
            throw new SimpleBitStorage.InitializationException("Invalid length given for storage, got: " + along.length + " but expected: " + l);
         }
