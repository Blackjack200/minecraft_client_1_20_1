...
public class ProcessorMailbox<T> implements ProfilerMeasured, ProcessorHandle<T>, AutoCloseable, Runnable {
   ...
   public static ProcessorMailbox<Runnable> create(Executor executor, String s) {
      return new ProcessorMailbox<>(new StrictQueue.QueueStrictQueue<>(new ConcurrentLinkedQueue<>()), executor, s);
   }

   public ProcessorMailbox(StrictQueue<? super T, ? extends Runnable> strictqueue, Executor executor, String s) {
