...
public interface WeightedEntry {
   ...
   public static class Wrapper<T> implements WeightedEntry {
      ...
      public static <E> Codec<WeightedEntry.Wrapper<E>> codec(Codec<E> codec) {
         return RecordCodecBuilder.create((recordcodecbuilder_instance) -> recordcodecbuilder_instance.group(codec.fieldOf("data").forGetter(WeightedEntry.Wrapper::getData), Weight.CODEC.fieldOf("weight").forGetter(WeightedEntry.Wrapper::getWeight)).apply(recordcodecbuilder_instance, WeightedEntry.Wrapper::new));
      }
   }
}
