...
public interface RangeArgument<T extends MinMaxBounds<?>> extends ArgumentType<T> {
   ...
   public static class Floats implements RangeArgument<MinMaxBounds.Doubles> {
      ...
      public static MinMaxBounds.Doubles getRange(CommandContext<CommandSourceStack> commandcontext, String s) {
         return commandcontext.getArgument(s, MinMaxBounds.Doubles.class);
      }
   ...
   public static class Ints implements RangeArgument<MinMaxBounds.Ints> {
      ...
      public static MinMaxBounds.Ints getRange(CommandContext<CommandSourceStack> commandcontext, String s) {
         return commandcontext.getArgument(s, MinMaxBounds.Ints.class);
      }
