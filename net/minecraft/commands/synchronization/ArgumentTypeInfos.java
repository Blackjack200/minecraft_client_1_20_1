...
public class ArgumentTypeInfos {
   ...
   private static <A extends ArgumentType<?>, T extends ArgumentTypeInfo.Template<A>> ArgumentTypeInfo<A, T> register(Registry<ArgumentTypeInfo<?, ?>> registry, String s, Class<? extends A> oclass, ArgumentTypeInfo<A, T> argumenttypeinfo) {
      BY_CLASS.put(oclass, argumenttypeinfo);
      return Registry.register(registry, s, argumenttypeinfo);
   }
   ...
   public static boolean isClassRecognized(Class<?> oclass) {
      return BY_CLASS.containsKey(oclass);
   }
