...
public class BuiltInRegistries {
   ...
   public static final DefaultedRegistry<EntityType<?>> ENTITY_TYPE = registerDefaultedWithIntrusiveHolders(Registries.ENTITY_TYPE, "pig", (registry) -> EntityType.PIG);
   ...
   public static final Registry<RuleBlockEntityModifierType<?>> RULE_BLOCK_ENTITY_MODIFIER = registerSimple(Registries.RULE_BLOCK_ENTITY_MODIFIER, (registry) -> RuleBlockEntityModifierType.PASSTHROUGH);
   ...
   public static final Registry<RecipeSerializer<?>> RECIPE_SERIALIZER = registerSimple(Registries.RECIPE_SERIALIZER, (registry) -> RecipeSerializer.SHAPELESS_RECIPE);
   public static final Registry<Attribute> ATTRIBUTE = registerSimple(Registries.ATTRIBUTE, (registry) -> Attributes.LUCK);
   public static final Registry<PositionSourceType<?>> POSITION_SOURCE_TYPE = registerSimple(Registries.POSITION_SOURCE_TYPE, (registry) -> PositionSourceType.BLOCK);
   ...
   public static final DefaultedRegistry<VillagerProfession> VILLAGER_PROFESSION = registerDefaulted(Registries.VILLAGER_PROFESSION, "none", (registry) -> VillagerProfession.NONE);
   ...
   public static final DefaultedRegistry<MemoryModuleType<?>> MEMORY_MODULE_TYPE = registerDefaulted(Registries.MEMORY_MODULE_TYPE, "dummy", (registry) -> MemoryModuleType.DUMMY);
   ...
   public static final Registry<LootItemConditionType> LOOT_CONDITION_TYPE = registerSimple(Registries.LOOT_CONDITION_TYPE, (registry) -> LootItemConditions.INVERTED);
   public static final Registry<LootNumberProviderType> LOOT_NUMBER_PROVIDER_TYPE = registerSimple(Registries.LOOT_NUMBER_PROVIDER_TYPE, (registry) -> NumberProviders.CONSTANT);
   ...
   public static final Registry<LootScoreProviderType> LOOT_SCORE_PROVIDER_TYPE = registerSimple(Registries.LOOT_SCORE_PROVIDER_TYPE, (registry) -> ScoreboardNameProviders.CONTEXT);
   ...
   public static final Registry<HeightProviderType<?>> HEIGHT_PROVIDER_TYPE = registerSimple(Registries.HEIGHT_PROVIDER_TYPE, (registry) -> HeightProviderType.CONSTANT);
   ...
   public static final Registry<StructurePlacementType<?>> STRUCTURE_PLACEMENT = registerSimple(Registries.STRUCTURE_PLACEMENT, (registry) -> StructurePlacementType.RANDOM_SPREAD);
   ...
   public static final Registry<PlacementModifierType<?>> PLACEMENT_MODIFIER_TYPE = registerSimple(Registries.PLACEMENT_MODIFIER_TYPE, (registry) -> PlacementModifierType.COUNT);
   public static final Registry<BlockStateProviderType<?>> BLOCKSTATE_PROVIDER_TYPE = registerSimple(Registries.BLOCK_STATE_PROVIDER_TYPE, (registry) -> BlockStateProviderType.SIMPLE_STATE_PROVIDER);
   public static final Registry<FoliagePlacerType<?>> FOLIAGE_PLACER_TYPE = registerSimple(Registries.FOLIAGE_PLACER_TYPE, (registry) -> FoliagePlacerType.BLOB_FOLIAGE_PLACER);
   public static final Registry<TrunkPlacerType<?>> TRUNK_PLACER_TYPE = registerSimple(Registries.TRUNK_PLACER_TYPE, (registry) -> TrunkPlacerType.STRAIGHT_TRUNK_PLACER);
   ...
   public static final Registry<TreeDecoratorType<?>> TREE_DECORATOR_TYPE = registerSimple(Registries.TREE_DECORATOR_TYPE, (registry) -> TreeDecoratorType.LEAVE_VINE);
   public static final Registry<FeatureSizeType<?>> FEATURE_SIZE_TYPE = registerSimple(Registries.FEATURE_SIZE_TYPE, (registry) -> FeatureSizeType.TWO_LAYERS_FEATURE_SIZE);
   ...
   public static final Registry<StructureProcessorType<?>> STRUCTURE_PROCESSOR = registerSimple(Registries.STRUCTURE_PROCESSOR, (registry) -> StructureProcessorType.BLOCK_IGNORE);
   public static final Registry<StructurePoolElementType<?>> STRUCTURE_POOL_ELEMENT = registerSimple(Registries.STRUCTURE_POOL_ELEMENT, (registry) -> StructurePoolElementType.EMPTY);
   ...
   private static <T> Registry<T> registerSimple(ResourceKey<? extends Registry<T>> resourcekey, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap) {
      return registerSimple(resourcekey, Lifecycle.stable(), builtinregistries_registrybootstrap);
   }

   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> resourcekey, String s, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap) {
      return registerDefaulted(resourcekey, s, Lifecycle.stable(), builtinregistries_registrybootstrap);
   }

   private static <T> DefaultedRegistry<T> registerDefaultedWithIntrusiveHolders(ResourceKey<? extends Registry<T>> resourcekey, String s, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap) {
      return registerDefaultedWithIntrusiveHolders(resourcekey, s, Lifecycle.stable(), builtinregistries_registrybootstrap);
   }

   private static <T> Registry<T> registerSimple(ResourceKey<? extends Registry<T>> resourcekey, Lifecycle lifecycle, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap) {
      return internalRegister(resourcekey, new MappedRegistry<>(resourcekey, lifecycle, false), builtinregistries_registrybootstrap, lifecycle);
   }

   private static <T> DefaultedRegistry<T> registerDefaulted(ResourceKey<? extends Registry<T>> resourcekey, String s, Lifecycle lifecycle, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap) {
      return internalRegister(resourcekey, new DefaultedMappedRegistry<>(s, resourcekey, lifecycle, false), builtinregistries_registrybootstrap, lifecycle);
   }

   private static <T> DefaultedRegistry<T> registerDefaultedWithIntrusiveHolders(ResourceKey<? extends Registry<T>> resourcekey, String s, Lifecycle lifecycle, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap) {
      return internalRegister(resourcekey, new DefaultedMappedRegistry<>(s, resourcekey, lifecycle, true), builtinregistries_registrybootstrap, lifecycle);
   }

   private static <T, R extends WritableRegistry<T>> R internalRegister(ResourceKey<? extends Registry<T>> resourcekey, R writableregistry, BuiltInRegistries.RegistryBootstrap<T> builtinregistries_registrybootstrap, Lifecycle lifecycle) {
      ResourceLocation resourcelocation = resourcekey.location();
      LOADERS.put(resourcelocation, () -> builtinregistries_registrybootstrap.run(writableregistry));
   ...
   private static <T extends Registry<?>> void validate(Registry<T> registry) {
      registry.forEach((registry2) -> {
         if (registry2.keySet().isEmpty()) {
            Util.logAndPauseIfInIde("Registry '" + registry.getKey(registry2) + "' was empty after loading");
         }
