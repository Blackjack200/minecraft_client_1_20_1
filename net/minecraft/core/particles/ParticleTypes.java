...
public class ParticleTypes {
   ...
   public static final ParticleType<DustParticleOptions> DUST = register("dust", false, DustParticleOptions.DESERIALIZER, (particletype) -> DustParticleOptions.CODEC);
   public static final ParticleType<DustColorTransitionOptions> DUST_COLOR_TRANSITION = register("dust_color_transition", false, DustColorTransitionOptions.DESERIALIZER, (particletype) -> DustColorTransitionOptions.CODEC);
   ...
   public static final ParticleType<SculkChargeParticleOptions> SCULK_CHARGE = register("sculk_charge", true, SculkChargeParticleOptions.DESERIALIZER, (particletype) -> SculkChargeParticleOptions.CODEC);
   ...
   public static final ParticleType<VibrationParticleOption> VIBRATION = register("vibration", true, VibrationParticleOption.DESERIALIZER, (particletype) -> VibrationParticleOption.CODEC);
   ...
   public static final ParticleType<ShriekParticleOption> SHRIEK = register("shriek", false, ShriekParticleOption.DESERIALIZER, (particletype) -> ShriekParticleOption.CODEC);
   ...
   private static SimpleParticleType register(String s, boolean flag) {
      return Registry.register(BuiltInRegistries.PARTICLE_TYPE, s, new SimpleParticleType(flag));
   }

   private static <T extends ParticleOptions> ParticleType<T> register(String s, boolean flag, ParticleOptions.Deserializer<T> particleoptions_deserializer, final Function<ParticleType<T>, Codec<T>> function) {
      return Registry.register(BuiltInRegistries.PARTICLE_TYPE, s, new ParticleType<T>(flag, particleoptions_deserializer) {
