...
public class LookAtPlayerGoal extends Goal {
   ...
   public LookAtPlayerGoal(Mob mob, Class<? extends LivingEntity> oclass, float f) {
      this(mob, oclass, f, 0.02F);
   }

   public LookAtPlayerGoal(Mob mob, Class<? extends LivingEntity> oclass, float f, float f1) {
      this(mob, oclass, f, f1, false);
   }

   public LookAtPlayerGoal(Mob mob, Class<? extends LivingEntity> oclass, float f, float f1, boolean flag) {
      this.mob = mob;
