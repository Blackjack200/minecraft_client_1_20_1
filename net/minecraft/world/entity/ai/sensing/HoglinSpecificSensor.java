...
public class HoglinSpecificSensor extends Sensor<Hoglin> {
   ...
   protected void doTick(ServerLevel serverlevel, Hoglin hoglin) {
      ...
      for(LivingEntity livingentity : nearestvisiblelivingentities.findAll((livingentity1) -> !livingentity1.isBaby() && (livingentity1 instanceof Piglin || livingentity1 instanceof Hoglin))) {
