...
public class MemoryModuleType<U> {
   ...
   private static <U> MemoryModuleType<U> register(String s, Codec<U> codec) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(s), new MemoryModuleType<>(Optional.of(codec)));
   }

   private static <U> MemoryModuleType<U> register(String s) {
      return Registry.register(BuiltInRegistries.MEMORY_MODULE_TYPE, new ResourceLocation(s), new MemoryModuleType<>(Optional.empty()));
   }
}
