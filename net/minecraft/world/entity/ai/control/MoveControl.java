...
public class MoveControl implements Control {
   ...
   private boolean isWalkable(float f, float f1) {
      ...
      if (pathnavigation != null) {
         ...
         if (nodeevaluator != null && nodeevaluator.getBlockPathType(this.mob.level(), Mth.floor(this.mob.getX() + (double)f), this.mob.getBlockY(), Mth.floor(this.mob.getZ() + (double)f1)) != BlockPathTypes.WALKABLE) {
            return false;
         }
      }
