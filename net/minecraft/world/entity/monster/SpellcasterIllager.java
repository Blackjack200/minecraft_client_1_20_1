...
public abstract class SpellcasterIllager extends AbstractIllager {
   ...
   public void setIsCastingSpell(SpellcasterIllager.IllagerSpell spellcasterillager_illagerspell) {
      ...
      this.entityData.set(DATA_SPELL_CASTING_ID, (byte)spellcasterillager_illagerspell.id);
   }
   ...
   protected static enum IllagerSpell {
      ...
      private static final IntFunction<SpellcasterIllager.IllagerSpell> BY_ID = ByIdMap.continuous((spellcasterillager_illagerspell) -> spellcasterillager_illagerspell.id, values(), ByIdMap.OutOfBoundsStrategy.ZERO);
      final int id;
