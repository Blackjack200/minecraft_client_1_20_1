...
public class SpawnPlacements {
   ...
   private static <T extends Mob> void register(EntityType<T> entitytype, SpawnPlacements.Type spawnplacements_type, Heightmap.Types heightmap_types, SpawnPlacements.SpawnPredicate<T> spawnplacements_spawnpredicate) {
      SpawnPlacements.Data spawnplacements_data = DATA_BY_TYPE.put(entitytype, new SpawnPlacements.Data(heightmap_types, spawnplacements_type, spawnplacements_spawnpredicate));
   ...
   public static SpawnPlacements.Type getPlacementType(EntityType<?> entitytype) {
      SpawnPlacements.Data spawnplacements_data = DATA_BY_TYPE.get(entitytype);
      return spawnplacements_data == null ? SpawnPlacements.Type.NO_RESTRICTIONS : spawnplacements_data.placement;
   }
   ...
   static class Data {
      ...
      public Data(Heightmap.Types heightmap_types, SpawnPlacements.Type spawnplacements_type, SpawnPlacements.SpawnPredicate<?> spawnplacements_spawnpredicate) {
         this.heightMap = heightmap_types;
         this.placement = spawnplacements_type;
         this.predicate = spawnplacements_spawnpredicate;
      }
   }
