...
public class EnderDragonPhase<T extends DragonPhaseInstance> {
   ...
   private EnderDragonPhase(int i, Class<? extends DragonPhaseInstance> oclass, String s) {
      this.id = i;
   ...
   private static <T extends DragonPhaseInstance> EnderDragonPhase<T> create(Class<T> oclass, String s) {
      EnderDragonPhase<T> enderdragonphase = new EnderDragonPhase<>(phases.length, oclass, s);
