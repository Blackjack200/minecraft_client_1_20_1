...
public class AxeItem extends DiggerItem {
   ...
   protected AxeItem(Tier tier, float f, float f1, Item.Properties item_properties) {
      super(f, f1, tier, BlockTags.MINEABLE_WITH_AXE, item_properties);
   }
   ...
   public InteractionResult useOn(UseOnContext useoncontext) {
      ...
      Optional<BlockState> optional2 = Optional.ofNullable(HoneycombItem.WAX_OFF_BY_BLOCK.get().get(blockstate.getBlock())).map((block) -> block.withPropertiesOf(blockstate));
