...
public interface RecipeType<T extends Recipe<?>> {
   ...
   static <T extends Recipe<?>> RecipeType<T> register(final String s) {
      return Registry.register(BuiltInRegistries.RECIPE_TYPE, new ResourceLocation(s), new RecipeType<T>() {
