...
public class SmithingTemplateItem extends Item {
   ...
   public SmithingTemplateItem(Component component, Component component1, Component component2, Component component3, Component component4, List<ResourceLocation> list, List<ResourceLocation> list1) {
      super(new Item.Properties());
      this.appliesTo = component;
      this.ingredients = component1;
      this.upgradeDescription = component2;
   ...
   public static SmithingTemplateItem createArmorTrimTemplate(ResourceLocation resourcelocation) {
      return new SmithingTemplateItem(ARMOR_TRIM_APPLIES_TO, ARMOR_TRIM_INGREDIENTS, Component.translatable(Util.makeDescriptionId("trim_pattern", resourcelocation)).withStyle(TITLE_FORMAT), ARMOR_TRIM_BASE_SLOT_DESCRIPTION, ARMOR_TRIM_ADDITIONS_SLOT_DESCRIPTION, createTrimmableArmorIconList(), createTrimmableMaterialIconList());
   }
