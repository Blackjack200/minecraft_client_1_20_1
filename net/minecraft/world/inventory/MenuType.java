...
public class MenuType<T extends AbstractContainerMenu> implements FeatureElement {
   ...
   private static <T extends AbstractContainerMenu> MenuType<T> register(String s, MenuType.MenuSupplier<T> menutype_menusupplier) {
      return Registry.register(BuiltInRegistries.MENU, s, new MenuType<>(menutype_menusupplier, FeatureFlags.VANILLA_SET));
   }
   ...
   private static <T extends AbstractContainerMenu> MenuType<T> register(String s, MenuType.MenuSupplier<T> menutype_menusupplier, FeatureFlag... afeatureflag) {
      return Registry.register(BuiltInRegistries.MENU, s, new MenuType<>(menutype_menusupplier, FeatureFlags.REGISTRY.subset(afeatureflag)));
   }
