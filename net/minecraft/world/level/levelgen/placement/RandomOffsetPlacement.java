...
public class RandomOffsetPlacement extends PlacementModifier {
   public static final Codec<RandomOffsetPlacement> CODEC = RecordCodecBuilder.create((recordcodecbuilder_instance) -> recordcodecbuilder_instance.group(IntProvider.codec(-16, 16).fieldOf("xz_spread").forGetter((randomoffsetplacement1) -> randomoffsetplacement1.xzSpread), IntProvider.codec(-16, 16).fieldOf("y_spread").forGetter((randomoffsetplacement) -> randomoffsetplacement.ySpread)).apply(recordcodecbuilder_instance, RandomOffsetPlacement::new));
