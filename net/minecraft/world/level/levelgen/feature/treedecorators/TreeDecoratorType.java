...
public class TreeDecoratorType<P extends TreeDecorator> {
   ...
   private static <P extends TreeDecorator> TreeDecoratorType<P> register(String s, Codec<P> codec) {
      return Registry.register(BuiltInRegistries.TREE_DECORATOR_TYPE, s, new TreeDecoratorType<>(codec));
   }
