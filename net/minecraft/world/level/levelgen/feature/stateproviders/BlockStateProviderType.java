...
public class BlockStateProviderType<P extends BlockStateProvider> {
   ...
   private static <P extends BlockStateProvider> BlockStateProviderType<P> register(String s, Codec<P> codec) {
      return Registry.register(BuiltInRegistries.BLOCKSTATE_PROVIDER_TYPE, s, new BlockStateProviderType<>(codec));
   }
