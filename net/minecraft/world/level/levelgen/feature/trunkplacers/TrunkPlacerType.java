...
public class TrunkPlacerType<P extends TrunkPlacer> {
   ...
   private static <P extends TrunkPlacer> TrunkPlacerType<P> register(String s, Codec<P> codec) {
      return Registry.register(BuiltInRegistries.TRUNK_PLACER_TYPE, s, new TrunkPlacerType<>(codec));
   }
