...
public interface StructurePieceType {
   ...
   private static StructurePieceType setFullContextPieceId(StructurePieceType structurepiecetype, String s) {
      return Registry.register(BuiltInRegistries.STRUCTURE_PIECE, s.toLowerCase(Locale.ROOT), structurepiecetype);
   }

   private static StructurePieceType setPieceId(StructurePieceType.ContextlessType structurepiecetype_contextlesstype, String s) {
      return setFullContextPieceId(structurepiecetype_contextlesstype, s);
   }

   private static StructurePieceType setTemplatePieceId(StructurePieceType.StructureTemplateType structurepiecetype_structuretemplatetype, String s) {
      return setFullContextPieceId(structurepiecetype_structuretemplatetype, s);
   }
