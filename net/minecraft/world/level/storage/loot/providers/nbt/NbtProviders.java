...
public class NbtProviders {
   ...
   private static LootNbtProviderType register(String s, Serializer<? extends NbtProvider> serializer) {
      return Registry.register(BuiltInRegistries.LOOT_NBT_PROVIDER_TYPE, new ResourceLocation(s), new LootNbtProviderType(serializer));
   }
