...
public class ScoreboardNameProviders {
   ...
   private static LootScoreProviderType register(String s, Serializer<? extends ScoreboardNameProvider> serializer) {
      return Registry.register(BuiltInRegistries.LOOT_SCORE_PROVIDER_TYPE, new ResourceLocation(s), new LootScoreProviderType(serializer));
   }
