...
public class NumberProviders {
   ...
   private static LootNumberProviderType register(String s, Serializer<? extends NumberProvider> serializer) {
      return Registry.register(BuiltInRegistries.LOOT_NUMBER_PROVIDER_TYPE, new ResourceLocation(s), new LootNumberProviderType(serializer));
   }
