...
public class LootPoolEntries {
   ...
   private static LootPoolEntryType register(String s, Serializer<? extends LootPoolEntryContainer> serializer) {
      return Registry.register(BuiltInRegistries.LOOT_POOL_ENTRY_TYPE, new ResourceLocation(s), new LootPoolEntryType(serializer));
   }
