...
public class LevelSummary implements Comparable<LevelSummary> {
   ...
   public LevelSummary(LevelSettings levelsettings, LevelVersion levelversion, String s, boolean flag, boolean flag1, boolean flag2, Path path) {
   ...
   private Component createInfo() {
      if (this.isLocked()) {
         ...
         MutableComponent mutablecomponent = this.isHardcore() ? Component.empty().append(Component.translatable("gameMode.hardcore").withStyle((style) -> style.withColor(-65536))) : Component.translatable("gameMode." + this.getGameMode().getName());
         if (this.hasCheats()) {
   ...
   public static enum BackupStatus {
      ...
      private BackupStatus(boolean flag, boolean flag1, String s) {
   ...
   public static class SymlinkLevelSummary extends LevelSummary {
      public SymlinkLevelSummary(String s, Path path) {
         super((LevelSettings)null, (LevelVersion)null, s, false, false, false, path);
      }
