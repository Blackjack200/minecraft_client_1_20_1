...
public interface WorldData {
   ...
   default void fillCrashReportCategory(CrashReportCategory crashreportcategory) {
      crashreportcategory.setDetail("Known server brands", () -> String.join(", ", this.getKnownServerBrands()));
      crashreportcategory.setDetail("Removed feature flags", () -> String.join(", ", this.getRemovedFeatureFlags()));
   ...
   void setEndDragonFightData(EndDragonFight.Data enddragonfight_data);
