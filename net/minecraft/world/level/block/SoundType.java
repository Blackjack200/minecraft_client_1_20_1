...
public class SoundType {
   ...
   public SoundType(float f, float f1, SoundEvent soundevent, SoundEvent soundevent1, SoundEvent soundevent2, SoundEvent soundevent3, SoundEvent soundevent4) {
      this.volume = f;
      this.pitch = f1;
      this.breakSound = soundevent;
      this.stepSound = soundevent1;
      this.placeSound = soundevent2;
      this.hitSound = soundevent3;
      this.fallSound = soundevent4;
   }
