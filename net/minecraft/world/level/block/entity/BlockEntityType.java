...
public class BlockEntityType<T extends BlockEntity> {
   ...
   private static <T extends BlockEntity> BlockEntityType<T> register(String s, BlockEntityType.Builder<T> blockentitytype_builder) {
      if (blockentitytype_builder.validBlocks.isEmpty()) {
         LOGGER.warn("Block entity type {} requires at least one valid block to be defined!", (Object)s);
      }

      Type<?> type = Util.fetchChoiceType(References.BLOCK_ENTITY, s);
      return Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE, s, blockentitytype_builder.build(type));
   }

   public BlockEntityType(BlockEntityType.BlockEntitySupplier<? extends T> blockentitytype_blockentitysupplier, Set<Block> set, Type<?> type) {
      this.factory = blockentitytype_blockentitysupplier;
   ...
   public static final class Builder<T extends BlockEntity> {
      ...
      private Builder(BlockEntityType.BlockEntitySupplier<? extends T> blockentitytype_blockentitysupplier, Set<Block> set) {
         this.factory = blockentitytype_blockentitysupplier;
         this.validBlocks = set;
      }

      public static <T extends BlockEntity> BlockEntityType.Builder<T> of(BlockEntityType.BlockEntitySupplier<? extends T> blockentitytype_blockentitysupplier, Block... ablock) {
         return new BlockEntityType.Builder<>(blockentitytype_blockentitysupplier, ImmutableSet.copyOf(ablock));
      }
