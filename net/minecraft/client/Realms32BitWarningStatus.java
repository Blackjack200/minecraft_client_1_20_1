...
public class Realms32BitWarningStatus {
   ...
   private boolean hasRealmsSubscription() {
      try {
         return RealmsClient.create(this.minecraft).listWorlds().servers.stream().anyMatch((realmsserver) -> realmsserver.ownerUUID != null && !realmsserver.expired && realmsserver.ownerUUID.equals(this.minecraft.getUser().getUuid()));
