...
public class AttackSweepParticle extends TextureSheetParticle {
   ...
   AttackSweepParticle(ClientLevel clientlevel, double d0, double d1, double d2, double d3, SpriteSet spriteset) {
      ...
      this.gCol = f;
      this.bCol = f;
      this.quadSize = 1.0F - (float)d3 * 0.5F;
   ...
   public static class Provider implements ParticleProvider<SimpleParticleType> {
      ...
      public Particle createParticle(SimpleParticleType simpleparticletype, ClientLevel clientlevel, double d0, double d1, double d2, double d3, double d4, double d5) {
         return new AttackSweepParticle(clientlevel, d0, d1, d2, d3, this.sprites);
      }
   }
}
