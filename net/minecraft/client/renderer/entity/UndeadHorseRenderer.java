...
public class UndeadHorseRenderer extends AbstractHorseRenderer<AbstractHorse, HorseModel<AbstractHorse>> {
   ...
   public UndeadHorseRenderer(EntityRendererProvider.Context entityrendererprovider_context, ModelLayerLocation modellayerlocation) {
      super(entityrendererprovider_context, new HorseModel<>(entityrendererprovider_context.bakeLayer(modellayerlocation)), 1.0F);
   }
