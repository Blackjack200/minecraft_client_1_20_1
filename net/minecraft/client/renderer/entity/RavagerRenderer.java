...
public class RavagerRenderer extends MobRenderer<Ravager, RavagerModel> {
   ...
   public RavagerRenderer(EntityRendererProvider.Context entityrendererprovider_context) {
      super(entityrendererprovider_context, new RavagerModel(entityrendererprovider_context.bakeLayer(ModelLayers.RAVAGER)), 1.1F);
   }
