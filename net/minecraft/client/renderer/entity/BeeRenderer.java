...
public class BeeRenderer extends MobRenderer<Bee, BeeModel<Bee>> {
   ...
   public BeeRenderer(EntityRendererProvider.Context entityrendererprovider_context) {
      super(entityrendererprovider_context, new BeeModel<>(entityrendererprovider_context.bakeLayer(ModelLayers.BEE)), 0.4F);
   }
