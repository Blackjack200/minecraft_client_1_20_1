...
public enum FaceInfo {
   ...
   private static final FaceInfo[] BY_FACING = Util.make(new FaceInfo[6], (afaceinfo) -> {
      afaceinfo[FaceInfo.Constants.MIN_Y] = DOWN;
      afaceinfo[FaceInfo.Constants.MAX_Y] = UP;
      afaceinfo[FaceInfo.Constants.MIN_Z] = NORTH;
      afaceinfo[FaceInfo.Constants.MAX_Z] = SOUTH;
      afaceinfo[FaceInfo.Constants.MIN_X] = WEST;
      afaceinfo[FaceInfo.Constants.MAX_X] = EAST;
   });
   ...
   private FaceInfo(FaceInfo.VertexInfo... afaceinfo_vertexinfo) {
      this.infos = afaceinfo_vertexinfo;
   }
