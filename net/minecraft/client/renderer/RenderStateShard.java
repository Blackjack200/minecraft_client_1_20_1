...
public abstract class RenderStateShard {
   ...
   public RenderStateShard(String s, Runnable runnable, Runnable runnable1) {
      this.name = s;
      this.setupState = runnable;
      this.clearState = runnable1;
   }
   ...
   private static void setupGlintTexturing(float f) {
      ...
      float f2 = (float)(i % 30000L) / 30000.0F;
   ...
   static class BooleanStateShard extends RenderStateShard {
      ...
      public BooleanStateShard(String s, Runnable runnable, Runnable runnable1, boolean flag) {
   ...
   protected static class ColorLogicStateShard extends RenderStateShard {
      public ColorLogicStateShard(String s, Runnable runnable, Runnable runnable1) {
         super(s, runnable, runnable1);
      }
   }

   protected static class CullStateShard extends RenderStateShard.BooleanStateShard {
      public CullStateShard(boolean flag) {
         super("cull", () -> {
            if (!flag) {
   ...
   protected static class DepthTestStateShard extends RenderStateShard {
      ...
      public DepthTestStateShard(String s, int i) {
         super("depth_test", () -> {
            if (i != 519) {
   ...
   protected static class EmptyTextureStateShard extends RenderStateShard {
      public EmptyTextureStateShard(Runnable runnable, Runnable runnable1) {
         super("texture", runnable, runnable1);
      }
   ...
   protected static class LayeringStateShard extends RenderStateShard {
      public LayeringStateShard(String s, Runnable runnable, Runnable runnable1) {
         super(s, runnable, runnable1);
      }
   }

   protected static class LightmapStateShard extends RenderStateShard.BooleanStateShard {
      public LightmapStateShard(boolean flag) {
         super("lightmap", () -> {
            if (flag) {
   ...
   protected static class MultiTextureStateShard extends RenderStateShard.EmptyTextureStateShard {
      ...
      public static final class Builder {
         ...
         public RenderStateShard.MultiTextureStateShard.Builder add(ResourceLocation resourcelocation, boolean flag, boolean flag1) {
            this.builder.add(Triple.of(resourcelocation, flag, flag1));
            return this;
         }
   ...
   protected static final class OffsetTexturingStateShard extends RenderStateShard.TexturingStateShard {
      public OffsetTexturingStateShard(float f, float f1) {
         super("offset_texturing", () -> RenderSystem.setTextureMatrix((new Matrix4f()).translation(f, f1, 0.0F)), () -> RenderSystem.resetTextureMatrix());
      }
   }

   protected static class OutputStateShard extends RenderStateShard {
      public OutputStateShard(String s, Runnable runnable, Runnable runnable1) {
         super(s, runnable, runnable1);
      }
   }

   protected static class OverlayStateShard extends RenderStateShard.BooleanStateShard {
      public OverlayStateShard(boolean flag) {
         super("overlay", () -> {
            if (flag) {
   ...
   protected static class TextureStateShard extends RenderStateShard.EmptyTextureStateShard {
      ...
      public TextureStateShard(ResourceLocation resourcelocation, boolean flag, boolean flag1) {
         super(() -> {
            TextureManager texturemanager = Minecraft.getInstance().getTextureManager();
            texturemanager.getTexture(resourcelocation).setFilter(flag, flag1);
   ...
   protected static class TexturingStateShard extends RenderStateShard {
      public TexturingStateShard(String s, Runnable runnable, Runnable runnable1) {
         super(s, runnable, runnable1);
      }
   }

   protected static class TransparencyStateShard extends RenderStateShard {
      public TransparencyStateShard(String s, Runnable runnable, Runnable runnable1) {
         super(s, runnable, runnable1);
      }
   }
   ...
   protected static class WriteMaskStateShard extends RenderStateShard {
      ...
      public WriteMaskStateShard(boolean flag, boolean flag1) {
         super("write_mask_state", () -> {
            if (!flag1) {
               RenderSystem.depthMask(flag1);
            }

            if (!flag) {
               RenderSystem.colorMask(flag, flag, flag, flag);
            }
         ...
         this.writeColor = flag;
         this.writeDepth = flag1;
      }
