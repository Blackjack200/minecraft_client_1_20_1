...
public class Main {
   ...
   public static void main(String[] astring) {
      ...
      File file = parseArgument(optionset, optionspec5);
      File file1 = optionset.has(optionspec6) ? parseArgument(optionset, optionspec6) : new File(file, "assets/");
      File file2 = optionset.has(optionspec7) ? parseArgument(optionset, optionspec7) : new File(file, "resourcepacks/");
      ...
      User.Type user_type = User.Type.byName(s13);
      if (user_type == null) {
         LOGGER.warn("Unrecognized user type: {}", (Object)s13);
      }

      User user = new User(optionspec12.value(optionset), s5, optionspec16.value(optionset), emptyStringToEmptyOptional(s7), emptyStringToEmptyOptional(s8), user_type);
      GameConfig gameconfig = new GameConfig(new GameConfig.UserData(user, propertymap, propertymap1, proxy), new DisplayData(i, j, optionalint, optionalint1, flag), new GameConfig.FolderData(file, file2, file1, s6), new GameConfig.GameData(flag1, s3, s4, flag2, flag3), new GameConfig.QuickPlayData(s9, s10, s11, s12));
   ...
   private static Optional<String> emptyStringToEmptyOptional(String s) {
