...
public class ModelLayers {
   ...
   private static ModelLayerLocation register(String s, String s1) {
      ModelLayerLocation modellayerlocation = createLocation(s, s1);
   ...
   private static ModelLayerLocation createLocation(String s, String s1) {
      return new ModelLayerLocation(new ResourceLocation("minecraft", s), s1);
   }

   private static ModelLayerLocation registerInnerArmor(String s) {
      return register(s, "inner_armor");
   }

   private static ModelLayerLocation registerOuterArmor(String s) {
      return register(s, "outer_armor");
   }

   public static ModelLayerLocation createRaftModelName(Boat.Type boat_type) {
      return createLocation("raft/" + boat_type.getName(), "main");
   }

   public static ModelLayerLocation createChestRaftModelName(Boat.Type boat_type) {
      return createLocation("chest_raft/" + boat_type.getName(), "main");
   }

   public static ModelLayerLocation createBoatModelName(Boat.Type boat_type) {
      return createLocation("boat/" + boat_type.getName(), "main");
   }

   public static ModelLayerLocation createChestBoatModelName(Boat.Type boat_type) {
      return createLocation("chest_boat/" + boat_type.getName(), "main");
   }
