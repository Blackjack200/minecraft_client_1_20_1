...
public class BoatModel extends ListModel<Boat> implements WaterPatchModel {
   ...
   protected ImmutableList.Builder<ModelPart> createPartsBuilder(ModelPart modelpart) {
      ...
      immutablelist_builder.add(modelpart.getChild("bottom"), modelpart.getChild("back"), modelpart.getChild("front"), modelpart.getChild("right"), modelpart.getChild("left"), this.leftPaddle, this.rightPaddle);
