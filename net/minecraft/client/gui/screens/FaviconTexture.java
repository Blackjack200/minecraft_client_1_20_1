...
public class FaviconTexture implements AutoCloseable {
   ...
   public static FaviconTexture forWorld(TextureManager texturemanager, String s) {
      return new FaviconTexture(texturemanager, new ResourceLocation("minecraft", "worlds/" + Util.sanitizeName(s, ResourceLocation::validPathChar) + "/" + Hashing.sha1().hashUnencodedChars(s) + "/icon"));
   }

   public static FaviconTexture forServer(TextureManager texturemanager, String s) {
      return new FaviconTexture(texturemanager, new ResourceLocation("minecraft", "servers/" + Hashing.sha1().hashUnencodedChars(s) + "/icon"));
   }
