...
public class TabManager {
   ...
   public TabManager(Consumer<AbstractWidget> consumer, Consumer<AbstractWidget> consumer1) {
      this.addWidget = consumer;
      this.removeWidget = consumer1;
   }
   ...
   public void setCurrentTab(Tab tab, boolean flag) {
