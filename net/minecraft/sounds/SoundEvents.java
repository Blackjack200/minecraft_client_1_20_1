...
public class SoundEvents {
   ...
   private static Holder<SoundEvent> register(ResourceLocation resourcelocation, ResourceLocation resourcelocation1, float f) {
      return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, resourcelocation, SoundEvent.createFixedRangeEvent(resourcelocation1, f));
   }
   ...
   private static Holder.Reference<SoundEvent> registerForHolder(String s) {
      return registerForHolder(new ResourceLocation(s));
   }
   ...
   private static SoundEvent register(ResourceLocation resourcelocation, ResourceLocation resourcelocation1) {
      return Registry.register(BuiltInRegistries.SOUND_EVENT, resourcelocation, SoundEvent.createVariableRangeEvent(resourcelocation1));
   }

   private static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation resourcelocation, ResourceLocation resourcelocation1) {
      return Registry.registerForHolder(BuiltInRegistries.SOUND_EVENT, resourcelocation, SoundEvent.createVariableRangeEvent(resourcelocation1));
   }
