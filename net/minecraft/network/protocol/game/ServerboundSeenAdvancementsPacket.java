...
public class ServerboundSeenAdvancementsPacket implements Packet<ServerGamePacketListener> {
   ...
   public ServerboundSeenAdvancementsPacket(ServerboundSeenAdvancementsPacket.Action serverboundseenadvancementspacket_action, @Nullable ResourceLocation resourcelocation) {
      this.action = serverboundseenadvancementspacket_action;
